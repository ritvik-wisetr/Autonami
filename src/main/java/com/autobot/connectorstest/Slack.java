...
public class Slack 
{
	public static void main(String[] args)  
	{
		...
		((JavascriptExecutor)driver).executeScript("window.open('https://wisetr.slack.com/','_blank');");
		...
		WebElement autonami=driver.findElement(By.xpath("//span[@data-qa='channel_sidebar_name_autonami']"));
		WebDriverCommonLib.elementDisplay("Autonami", autonami, driver);
		
		String expMsg1="Autonami";
		String actMsg1=autonami.getText();
		...
		WaitStatementLib.iSleep(2);
		driver.findElement(By.xpath("//span[@data-qa='channel_sidebar_name_woo-autobot']")).click();
