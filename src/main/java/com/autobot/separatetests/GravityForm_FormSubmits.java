...
public class GravityForm_FormSubmits {
	...
	public static void main(String[] args) 
	{
		...
		driver.get("https://autonami.bwfdemo.in/gravity-form/");
		...
		driver.findElement(By.id("input_1_1")).sendKeys("Ritvik");
		driver.findElement(By.id("input_1_2")).sendKeys("Raj");
		driver.findElement(By.id("input_1_3")).sendKeys(formattedDate+"@tact9.in");
		...
		WaitStatementLib.iSleep(2);
		driver.findElement(By.id("bwfan-search-input")).sendKeys("Testing Gravity Form Submits");
		WaitStatementLib.iSleep(2);
		driver.findElement(By.id("search-submit")).click();
		
		WaitStatementLib.iSleep(2);
		driver.findElements(By.xpath("//div[@class='bwfan-extra-details']//span[contains(text(),'1')]/../../../..//a[contains(text(),'Testing Gravity Form Submits')]/../..//a[text()='Run Now']")).get(0).click();
