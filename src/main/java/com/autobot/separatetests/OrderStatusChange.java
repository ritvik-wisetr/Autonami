...
public class OrderStatusChange extends BaseLib
{
...
//		for(int i=0; i<2; i++)
//		{
			driver.findElements(By.xpath("//div[@class='bwfan-extra-details']//a[contains(text(),'"+orderNumber+"')]/../../../..//a[contains(text(),'Testing Order Status Change')]/../..//a[text()='Run Now']")).get(0).click();
