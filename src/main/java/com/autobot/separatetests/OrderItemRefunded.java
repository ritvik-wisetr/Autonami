...
public class OrderItemRefunded {
	...
	public static void main(String[] args) 
	{
		...
		WebDriverCommonLib.selectOptionByValue(orderStatusDrpDwn, "wc-refunded");
...
//		for(int i=0; i<2; i++)
//		{
			driver.findElements(By.xpath("//div[@class='bwfan-extra-details']//a[contains(text(),'"+orderNumber+"')]/../../../..//a[contains(text(),'Testing Order Item Refunded')]/../..//a[text()='Run Now']")).get(0).click();
