...
public class SendEmailParametersTesting {
	...
	public static void main(String[] args) 
	{
		...
		driver.findElements(By.xpath("//div[@class='bwfan-extra-details']//a[contains(text(),'"+orderNumber+"')]/../../../..//a[contains(text(),'Testing Send Email Action Parameters')]/../..//a[text()='Run Now']")).get(0).click();
		WaitStatementLib.iSleep(3);
		...
		boolean isFound1 = url.contains("utm_source=apple");
		System.out.println(isFound1);
		boolean isFound2 = url.contains("utm_medium=ball");
		System.out.println(isFound2);
		boolean isFound3 = url.contains("utm_campaign=cat");
		System.out.println(isFound3);
		boolean isFound4 = url.contains("utm_term=dog");
		System.out.println(isFound4);
	}
